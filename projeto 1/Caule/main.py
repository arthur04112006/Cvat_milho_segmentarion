...
# Salvar resultados
cv2.imwrite("resultado_contornos_caule.jpg", image_contornos)
cv2.imwrite("mascara_segmentacao_caule.jpg", mascara)
cv2.imwrite("imagem_segmentada_caule.jpg", segmentada)
